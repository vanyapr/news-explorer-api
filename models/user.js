...
const userSchema = new Schema({
  ...
  password: {
    type: String,
    required: true,
    minlength: 5, // Установили минимальную длину пароля в 5 символов, потому что хотим
    select: false, // Запретили базе возвращать поле пароля напрямую
  },
  name: {
    type: String,
    required: true,
...
// Статичный метод проверки имейла и пароля пользователя с хранимыми в базе данных
